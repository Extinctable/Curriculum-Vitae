...
\newcommand*{\address}{8150 Ave Marco-Polo, Montreal, Quebec H1E 5Y7}

%Commands for the Body Paragraphs
\newcommand*{\position}{Software Engineering Intern}
\newcommand*{\companyDetails}{its focus on providing innovative, reliable, and efficient POS solutions that empower businesses to streamline their operations and improve customer experiences}
\newcommand*{\positionDetails}{contribute to the development of cutting-edge software for POS systems, leveraging my skills in creating scalable and user-friendly solutions}
