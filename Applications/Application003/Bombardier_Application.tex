...
\newcommand*{\company}{Bombardier Aeronautique}
\newcommand*{\address}{400 Boulevard Cote Vertu Ouest, Dorval, Quebec H4S 1Y9}

%Commands for the Body Paragraphs
\newcommand*{\position}{Software Engineering Intern}
\newcommand*{\companyDetails}{its commitment to innovation and excellence in the aerospace and transportation industries, leading the development of cutting-edge aircraft and mobility solutions}
\newcommand*{\positionDetails}{contribute to the advancement of intelligent software systems that enhance aircraft performance and operational efficiency}
...
Additionally, I have experience in agile software development and have actively participated in every phase of the software development lifecycle, from implementation to deployment of web-based applications. My academic projects, such as creating an online Food Database System and a Teacher-Student Feedback Web Application, allowed me to refine my expertise in Python, JavaScript, Node.js, React, and SQL while working with APIs and relational databases. These projects taught me to write clean, efficient code using best practices and validate test procedures, including unit testing.
