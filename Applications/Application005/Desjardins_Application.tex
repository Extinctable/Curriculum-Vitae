...
\newcommand*{\company}{Desjardins}
\newcommand*{\address}{100 Rue des Commandeurs, Lévis, Québec G6V 7N5}

%Commands for the Body Paragraphs
\newcommand*{\position}{Software Developer Intern}
\newcommand*{\companyDetails}{its commitment to innovation in the financial services sector by developing advanced digital solutions to better serve its members and clients}
\newcommand*{\positionDetails}{contribute to the development of secure and scalable software solutions that enhance user experience and improve the efficiency of financial services}
